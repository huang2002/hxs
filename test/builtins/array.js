...
module.exports = (ctx) => {
    ...
    ctx.assertStrictEqual(evalCode(`a = [1, 2, 3]; Array.every(a, @(x, i) { return((x & 1) === 1) })`), false);
    ctx.assertStrictEqual(evalCode(`a = [1, 2, 3]; Array.every(a, @(x, i) { return(x > 0) })`), true);
    ...
    ctx.assertStrictEqual(evalCode(`a = [1, 2, 3]; Array.some(a, @(x, i) { return((x & 1) === 1) })`), true);
    ctx.assertStrictEqual(evalCode(`a = [1, 2, 3]; Array.some(a, @(x, i) { return(x <= 0) })`), false);
